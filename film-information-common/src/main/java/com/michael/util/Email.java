...
public class Email {
    ...
    public static String myEmailAccount = "1287646107@qq.com";
    public static String myEmailPassword = "eekxrrtlfoupgifa";
	...
	public void sendEmail(String receiveMailAccount,String text) throws Exception{
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String text) throws Exception {
        ...
        //    Cc: 抄送（可选）
        message.setRecipient(MimeMessage.RecipientType.CC, new InternetAddress("michaelSKST@outlook.com", "USER_EE", "UTF-8"));
        ...
        message.setContent("尊敬的"+"用户"+"，您的验证码为："+text+",请在五分钟内完成操作", "text/html;charset=UTF-8");
